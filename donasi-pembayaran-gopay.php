...
<div class="container">
    <div class="row" style="margin-left: -80px;font-family: Red Rose;">
        <div class="col-xl-7" style="margin-left:60px;width: 600px;">
            <div class="container" style="padding: 30px; background-color: white;margin-top: 20px;width: 600px; height: 520px;border-radius: 30px;border:1px solid black;font-size: 17px;">
            <div class="row">
                <div class="col-sm-12" style="margin-top: -40px;">
                    <img src="<?= base_url() ?>gopay.png" alt="" style="height: 90px; width: 90px;margin-left: 6px;">
                </div>
            </div>
            <div class="container" style="margin-left: -12px;">
                <div class="row">
                    <div class="col-sm-12">
                        <h6>Petunjuk Transaksi Gopay  :</h6>
                    </div>
                </div>  
                <div class="row justify-content-center" style="font-size: 11pt;">
                    <div class="col-sm-12">
                        <ol type="1" class="menu" style="margin-left: -17px;">
                            <li>Buka aplikasi Gojek</li>
                            <li>Pada tampilan utama aplikasi Gojek, langsung saja kalian klik Lainnya</li>
                            <li>Dihalaman selanjutnya silahkan anda pilih saja menu Tarik</li>
                            <li>Lalu dilanjutkan untuk memilih menu Ke Rekening Bank pada bagian bawah</li>
                            <li>Kemudian tinggal tap saja menu Transfer Instan Ke Rekening Baru</li>
                            <li>Masukan bank sesuai dengan pemilihan pada saat transaksi di Tokopedia sebelumnya</li>
                            <li>Selanjutnya silahkan saja paste nomor virtual account yang sudah kalian copy pada kolom tersedia</li>
                            <li>Jangan sampai lupa masukan jumlah nominal sesuai denga tagihan di Tokopedia</li>
                            <li>Pastikan terlebih dahulu detail pembayaran sudah benar, jika sudah benar maka klik saja Konfirmasi dan Bayar</li>
                            <li>Langkah terakhir cukup masukan saja PIN Gopay anda, jika sudah akan muncl notifikasi pembayaran anda berhasil</li>
                            <li>Silahkan anda cek menu notifikasi pada aplikasi Donasi TaPe, untuk mengetahui pembayaran sudah terverifikasi apa belum</li>
                        </ol>
                    </div>
                </div>  
            </div>
        ...
        <div class="col-xl-5" style="margin-left: 30px;margin-top:20px;font-family: Red Rose;">
                <div class="container pt-3"
                    ...
                    <form action="<?= base_url() ?>logic/donasi-gopay.php" method="post" enctype="multipart/form-data">
