...
<head>
    ...
    <title>FAQ | Tambah Data FAQ</title>
    ...
    <div class="row no-gutters ">
        ...
        <div class="col-md-10 p-5 pt-2" style="margin-top: 50px;">
            <div class="row text-dark">
                <h3>Tambah Data FAQ | <b>Admin</b>
                </h3><hr>
                <form method="POST" action="<?= base_url(); ?>logic/tambahfaqa.php">
                <div class="container">                  
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" name="pertanyaan" style="height: 50px; margin-left: 50px">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" name="jawaban" style="height: 100px;margin-left: 50px">
                                </div>
                            </div>
                        </div>
