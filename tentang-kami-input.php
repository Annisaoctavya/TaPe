...
<head>
    ...
    <title>Tentang Kami Input</title>
    ...
    <link rel="stylesheet" href="tentang-kami-input.css">
<link rel="stylesheet" href="<?= base_url() ?>tentang-kami-input.css">
    ...
    <div class="form"> 
        <div class="container">
             <div class="form-log">
                ...
                <form method="POST" action="<?= base_url(); ?>logic/kamiinput.php">
                    <div class="form-group">
                      <label for="usr">Email:</label>
                      <input type="email" class="form-control" id="email" name="email" value="<?= $rows['email_user'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="comment">Komentar:</label>
                        <textarea class="form-control" rows="5" id="comment" name="komentar"></textarea>
                    </div>
                    <button style=" margin-top: 30px; border: none; border-radius: 15px; width: 170px; margin-left: 300px; margin-bottom: 20px;
