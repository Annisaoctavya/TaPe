...
<head>
    ...
    <title>Hubungi Kami Admin</title>
    ...
    <div class="row no-gutters ">
        <div class="col-md-2 pr-3 pt-4" style="background-color: #f8f9fa;height: 1100px;">
            <ul class="nav flex-column ml-3 mb-5"  style="position:fixed; margin-left: 30px; margin-top: -8px;">
                ...
                <li class="nav-item ">
                  <a class="nav-link  text-black" href="Tentang Kami Admin.php"><i class="fa fa-info-circle" aria-hidden="true"></i> Tentang Kami</a><hr class="bg-secondary"  style="margin-top: 15px;">
                </li>
                <li class="nav-item">
            ...
            <div class="row text-dark">
                <h3>Hubungi Kami  | <b>Admin</b>
                    ...
                    <div class="container" style="text-align: center;">
                        <?php
                            $query = "select * from hubungi_kami";
                            $sQuery = mysqli_query($conn,$query);
                            while($row=mysqli_fetch_array($sQuery)){
                        ?>
                            <div class="row justify-content-center">
                                <div class="col-sm-4 isi">
                                    <p><?= $row["email_user"]; ?></p>
                                </div>
                                <div class="col-sm-4">
                                    <p><?= $row["isi_pesan"]; ?></p>
                                ...
                                <div class="col-sm-4" style="align-items: center;">
                                    <a href="<?= base_url() ?>kirimjawaban.php/?email=<?= $row["1"] ?>">
                                        <button style="border: none; background-color: inherit;">
                                            <img style="height: 50px; width: 50px;" src="question.png" alt="">
                                        </button> 
                                    </a>
                                </div>
                            </div>
