    ...
    <div class="row no-gutters ">
        ...
        <div class="col-md-10 p-5 pt-2" style="margin-top :50px;">
            <div class="row text-dark">
                ...
                <div class="container" style="text-align: center;">
                    <div class="row justify-content-center">
                        ...
                        <a style="border: none; color: inherit;"
                            href="<?= base_url(); ?>logic/hapuspenerima.php/?id=<?= $row[0]; ?>" >
                ...
                <?php } ?>            
                <hr>
                <a href="tambahpenerima.php">
                    <button style=" margin-top: 20px; border: none; border-radius: 20px; width: 200px; margin-left: 770px; margin-bottom: 20px;background-color: #7fdcda;" class="btn btn-outline-dark" type="submit">Tambah</button>
            </div>
        </div>
    </div>
</body>
