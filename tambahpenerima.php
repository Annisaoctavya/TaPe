...
<head>
    ...
    <title>Tambah Data Penerima | Penerima</title>
    ...
    <div class="row no-gutters ">
        ...
        <div class="col-md-10 p-5 pt-2" style="margin-top: 50px;">
            <div class="row text-dark">
                <h3>Tambah Data Penerima | <b>Admin</b>
                </h3><hr>                
                <form method="POST" action="<?= base_url(); ?>logic/tambahdatapenerima.php">
                <div class="container">                                
                        <div class="container">                        
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="penerima" style="height: 50px;">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="dusun" style="height: 50px;">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="desa" style="height: 50px;">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="kecamatan" style="height: 50px;">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-sm-2">
                                    <label for="">Barang Donasi</label>
                                </div>
                                <div class="col-sm-10">
                                    <input type="text" name="barang" style="height: 50px;">
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="jenjang" style="height: 50px;">
                                </div>
                            </div>
                        </div>                    
                </div>
