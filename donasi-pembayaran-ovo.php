            ...
            <div class="container">
                <div class="row" style="margin-left: -80px;font-family: Red Rose;">
                    <div class="col-xl-7" style="margin-left:60px;width: 600px;">
                        <div class="container"
                            style="padding: 30px; background-color: white;margin-top: 20px;width: 600px; height: 450px;border-radius: 30px;border:1px solid black;font-size: 17px;">
                            <div class="row">
                                <div class="col-sm-12" style="margin-top: -20px;">
                                    <img src="<?= base_url() ?>logo-ovo.png" alt="" style="width: 100px;height: 50px; margin-left: 6px;">
                                </div>
                            </div>
                            <div class="container" style="margin-left: -12px;">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h6>Petunjuk Transaksi OVO :</h6>
                                    </div>
                                </div>
                                <div class="row justify-content-center" style="font-size: 11pt;">
                                    <div class="col-sm-12">
                                        <ol type="1" class="menu" style="margin-left: -17px;">
                                            ...
                                            <li>Pada tampilan utama aplikasi OVO, pilih transfer kemudian pilih rekening bank
                                            </li>
                                            <li>Pada kolom bank tujuan pilih Mandiri kemudian pada kolom no rekening masukan
                                            nomor virtual account yang tadi kita dapatkan dari Donasi TaPe.</li>
                                            <li>Pada kolom nominal transfer masukan jumlah tagihan di Donasi TaPe lalu tap
                                            Lanjutkan.</li>
                                            <li>Pada halaman konfirmasi transfer, periksa kembali apakah semua data yang diinput
                                                sudah benar atau belum, jika benar maka akan muncul username Donasi TaPe dan
                                            untuk melanjutkan pembayaran tap tombol Transfer.</li>
                                            <li>Masukan security code akun OVO.</li>
                                            <li>Jika pembayaran Donasi TaPe via OVO berhasil maka akan muncul pemberitahuan dan
                                                tagihan di Donasi TaPe akan otomatis terbayar tanpa harus konfirmasi secara
                                            manual.</li>
                                        </ol>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-5" style="margin-left: 30px;margin-top:20px;font-family: Red Rose;">
                        <div class="container pt-3"
                            ...
                            <form action="<?= base_url() ?>logic/donasi-ovo.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-3 footer-brand animated fadeInLeft">
                    <div class="footernya">
                        ...
                        <h2>Donasi TaPe </h2>
                        <p>Donasi TaPe adalah wadah online untuk mempertemukan relawan/donatur yang ingin menyumbangkan uang
                        untuk diberikan kepada pelajar yang kurang mampu</p>
                    </div>
                </div>
