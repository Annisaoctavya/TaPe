            ...
            <div class="container" style="margin-top: 20px; margin-bottom: 20px;background-color: lightgrey;
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-sm-8">
                            <div class="container">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-sm-8"> <input type="text" class="form-control" id="nama" value="<?= $rows['fullname']; ?>" readonly> </div>
                                </div>
                            </div>
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-4"> <label for="" class="form-label">Email</label></div>
                                    <div class="col-sm-8"> <input type="text" class="form-control" id="email" value="<?= $rows['email_user']; ?>" readonly> </div>
                                </div>
                            </div>
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-4"> <label for="" class="form-label">Nomor Telepon</label></div>
                                    <div class="col-sm-8"> <input type="text" class="form-control" id="no_tlp" value="<?= $rows['no_tlp']; ?>" readonly> </div>
                                </div>
                            </div>
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-sm-4"> <label for="" class="form-label">Jenis Kelamin</label></div>
                                    <div class="col-sm-8"> <input type="text" class="form-control" id="gender" value="<?= $rows['gender']; ?>" readonly> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <a href="<?= base_url()?>profiledit.php/?function=getDataProfil&id=<?= $_SESSION['id'] ?>" style=" margin-top: 20px; border: none; border-radius: 20px; width: 200px; margin-left: 25px; margin-bottom: 20px;
                            background-color: #7fdcda;"  class="btn btn-outline-dark">Edit
                        </a>
                        <a href="http://localhost/tape/logic/logout.php" style=" margin-top: 20px; border: none; border-radius: 20px; width: 200px; margin-left: 25px; margin-bottom: 20px;
                            background-color: #7fdcda;"  class="btn btn-outline-dark">Keluar
                        </a>
                    </div>
                </div>
            </div>
